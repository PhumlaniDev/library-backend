...
import com.phumlani_dev.library.token.Token;
import com.phumlani_dev.library.token.TokenRepository;
import com.phumlani_dev.library.token.TokenType;
...
public class AuthenticationService {
    ...
    private void revokeAllUserTokens(User user) {
        var validUserToken = tokenRepository.findAllValidTokenByUser(Math.toIntExact(user.getId()));
